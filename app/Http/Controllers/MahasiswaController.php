...
class MahasiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // create data menggunakan mass assigment
        Mahasiswa::create($validateData);

        // flash data (ketika data berhasil diinput maka akan ada alert dialaog dan redirect ke index)
    ...
    {
        // route model binding, ini cara magic untuk menampilkan page selanjutnya sesuai dengan id
